// AI Chat Functionality with File Upload and Deepseek API using PapaParse
(function() {
    ...
    function initChat() {
        ...
        // Tokenize function for TF-IDF (same as reference.html)
        ...
        // Handle file upload with PapaParse
        if (fileInput) {
...
• "Show me all engineers"`, false);
                    ...
                    // Update file label and add success animation
                    if (fileLabel) {
        ...
        // Event listeners - using multiple methods to ensure they work
        ...
        if (chatInput) {
            ...
            // Method 1: addEventListener for keypress
